...
plt.savefig("/home/amigos/fuel_generator_monitor/static/img/24h_img/Oil_pressure")
#plt.show()
...
plt.savefig("/home/amigos/fuel_generator_monitor/static/img/24h_img/Coolant_temp")
...
plt.savefig("/home/amigos/fuel_generator_monitor/static/img/24h_img/ChgAltnV")
...
plt.savefig("/home/amigos/fuel_generator_monitor/static/img/24h_img/Battery_voltage")
#Engine_speed
data = []
time_list = []
for i in data_list:
...
plt.savefig("/home/amigos/fuel_generator_monitor/static/img/24h_img/Engine_speed")
#Frequency
data = []
time_list = []
for i in data_list:
...
plt.savefig("/home/amigos/fuel_generator_monitor/static/img/24h_img/Frequency")
...
plt.savefig("/home/amigos/fuel_generator_monitor/static/img/24h_img/L1-L3voltage")
...
ax1.grid()
ax1.legend(loc = 'upper right')
plt.savefig("/home/amigos/fuel_generator_monitor/static/img/24h_img/relative_voltage")
...
ax1.grid()
ax1.legend(loc = 'upper right')
plt.savefig("/home/amigos/fuel_generator_monitor/static/img/24h_img/L1-L3ampare")
...
plt.savefig("/home/amigos/fuel_generator_monitor/static/img/24h_img/Earth_current")
#L1~L3wattage
data1 = []
data2 = []
data3 = []
...
ax1.grid()
ax1.legend(loc = 'upper right')
plt.savefig("/home/amigos/fuel_generator_monitor/static/img/24h_img/L1-L3wattage")
...
plt.savefig("/home/amigos/fuel_generator_monitor/static/img/24h_img/Total_wattage")
#running_generator
data = []
time_list = []
for i in data_list:
...
plt.savefig("/home/amigos/fuel_generator_monitor/static/img/24h_img/running_generator")
